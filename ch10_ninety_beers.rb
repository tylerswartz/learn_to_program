...
while beers > 2
	puts english_number(beers).capitalize + ' bottles of beer on the wall, ' + 
      english_number(beers) + ' bottles of beeeerr!!'
  beers = beers - 1
	puts 'take one down, pass it around ' + english_number(beers) + ' bottles of beer on the wall!'

end
		puts 'Two bottles of beer on the wall!'
    puts 'Two bottles of beeeerr!!'
